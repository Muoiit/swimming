...
@section('content')
  <div class="page-wrapper">
            ...
            {!! Form::model($owner,['method'=>'PATCH','action'=>['AdminOwnersController@update',$owner->id],'class'=>'form','files'=>true]) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            {!! Form::text('facebook', $owner->facebook, ['class'=>'form-control'])!!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                         {!! Form::label('twitter', 'Link Twitter',['class' => 'col-2 col-form-label']) !!}
                                        <div class="col-10">
                                            {!! Form::text('twitter', $owner->twitter, ['class'=>'form-control'])!!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                         {!! Form::label('youtube', 'Link Youtube',['class' => 'col-2 col-form-label']) !!}
                                        <div class="col-10">
                                            {!! Form::text('youtube', $owner->youtube, ['class'=>'form-control'])!!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                          {!! Form::label('googleplus', 'Link Google+',['class' => 'col-2 col-form-label']) !!}
                                        <div class="col-10">
                                            {!! Form::text('googleplus', $owner->googleplus, ['class'=>'form-control'])!!}
                                        </div>
                                    </div>
