                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-block">                              
                                 <h4 class="card-title">Thêm thông tin Instructor</h4>
                                <h6 class="card-subtitle"></h6>
                            {!! Form::open(['method'=>'POST', 'action'=> 'AdminInstructorsController@store','class'=>'form','files'=>true]) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            {!! Form::textarea('intro', null, ['class'=>'form-control summernote '])!!}
                                        </div>                                        
                                    </div>

                                    <div class="form-group row">
                                        {!! Form::label('role', 'Role',['class' => 'col-2 col-form-label']) !!}
                                        <div class="col-10">
